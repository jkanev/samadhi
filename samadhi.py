...
class Mind:
    ...
    def _create_eegpsd_display_tab(self, create):
        ...
        if create:
            ...
            self._parent_tabwidget.setTabText(self._parent_tabwidget.indexOf(self._eegpsd_tab), self._name)
    ...
    def _create_dancing_dots_display_tab(self, create):
        ...
        if create:
            ...
            self._parent_tabwidget.setTabText(self._parent_tabwidget.indexOf(self._ddots_tab), self._name)
            ...
            for f0 in np.arange(0, 1000, 0.01):
                ...
                for m in range(0, M):
                    ...
                    if first:
                        try:
                            if len(last_data):
                                [lines[m]] = ax.plot(t[m], p * last_data + q * data, '.', linewidth=thickness,
